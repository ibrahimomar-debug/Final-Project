                     ...
                     <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left"><h3 class="title-5 m-b-18">Resident Information Management</h3></div>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    ...
                                    <?php
                                        ...
                                        $db = mysqli_select_db($connection, 'residentinfo_db');

                                        $message = "SELECT * FROM residentinfo_table";
                                    ...
                                    ?>
                                        ...
                                        <tbody class="table-body">
                                           <tr class="spacer"></tr>
                                                ...
                                                <td><?php echo $row['votertStatus']; ?></td>
  ...
  <div class="modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalCenteredLabel">RESIDENT REGISTRATION FORM</h4>
     ...
     <form action="residentReg.php" id="myForm" method="POST">
...
<hr>
        ...
        <div class="col-xl-12">
                ...
                <div class="row"> 
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Nationality</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Religion / Belief</label>
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                            <label for="nf-email" class=" form-control-label">Occupation</label>
                            <select name="occupation" id="occupation" class="form-control">
                                ...
                                <option value="Persons with Disablity (PWD)">Persons with Disablity (PWD)</option>
                ...
                <div class="row"> 
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Spouse’s Name </label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label"> Spouse’s Occupation</label>
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                            <label for="nf-email" class=" form-control-label">Voter Status</label>
...
<hr>                
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">City Address</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Provincial Address</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="emailAdd" name="emailAdd" placeholder="Enter Email Address" class="form-control">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Home Number 1</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Home Number 2</label>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Mobile Number 1</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Mobile Number 2</label>
...
<hr>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Resident Type</label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nf-email" class="form-control-label">Resident Status</label>
...
<!-- End of Modal -->
    ...
    <script src="js/saveresident.js"></script>
