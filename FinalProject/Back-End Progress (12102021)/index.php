                        ...
                        <div class="login-form">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="resident-id" name="resident-id" placeholder="Enter Username">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" onclick=" return logInfunction()" name="register" id="register">sign in</button>
                            </form>
