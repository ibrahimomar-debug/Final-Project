      ...
      <div class="page-container2">
        ...
        <!-- END PAGE CONTAINER-->
              ...
              <div class="modal fade" id="filemodal" tabindex="-1">
                ...
                <button type="button" class="btn btn modal-button-color text-white w-50">Barangay Clearance</button>
                <form action="COR.php" method="POST">
                <input type="hidden" value="<?php echo $_SESSION["firstName"]. " " .$_SESSION["lastName"] ?>" name="GeneratedBy" id="GenerateBy">
                <input type="hidden" name="GenerateResidentID" id="GenerateResidentID">
                <input type="hidden" name="GenerateFamilyName" id="GenerateFamilyName">
                <input type="hidden" name="GenerateFirstName" id="GenerateFirstName">
                <input type="hidden" name="GenerateMiddleName" id="GenerateMiddleName">
                <input type="hidden" name="GenerateBirthDate" id="GenerateBirthDate">
                <input type="hidden" name="GenerateCivilStatus" id="GenerateCivilStatus">
                <input type="hidden" name="GenerateNationality" id="GenerateNationality">
                <input type="hidden" name="GenerateResidentStatus" id="GenerateResidentStatus">
