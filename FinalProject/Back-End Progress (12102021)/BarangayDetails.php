...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="BarangayDetails.css" />
                    ...
                    <nav class="navbar-sidebar2 ">
                        <ul class="list-unstyled navbar__list ">
                            <li class="active has-sub">
                                <a class="js-arrow" href="index_Main.html"  style="text-decoration: none;">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a  href="Manage_Issuance.html"  style="text-decoration: none;">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a  href="BarangayDetails.php"  style="text-decoration: none;">
                                        <i class="fas fa-tasks"></i>Barangay Details</a>
                                    </li>
                                </ul>                                
                            </li>
                        </ul>
                                    ...
                                    <div class="au-breadcrumb-content">
                                        <div class="au-breadcrumb-left">
                                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                                ...
                                                <li class="list-inline-item">Barangay Details</li>
                                            </ul>
                                        </div>
