...
<head>
    ...
    <link rel="stylesheet" href="ManageIssuance.css" />
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <form action="BC.php" class="needs-validation" method="POST" novalidate>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                <div id="invoice" class="p-3">
                                    ...
                                    <div class="row">                                       
                                        <div class="col-lg-4">                                          
                                            <label class="mt-3 " for="familyName">Family Name</label>
                                            <input type="text" placeholder="Enter Family Name" class="form-control" id="GenerateFamilyName" name="GenerateFamilyName" required>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="mt-3" for="firstName">First Name</label>
                                            <input type="text" placeholder="Enter First Name" class="form-control" id="GenerateFirstName" name="GenerateFirstName" required>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="mt-3" for="middleName">Middle Name</label>
                                            <input type="text" placeholder="Enter Middle" class="form-control" id="GenerateMiddleName" name="GenerateMiddleName" required>
                                        </div>                                       
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">                                          
                                            <label class="mt-3 " for="residentID">Resident ID</label>
                                            <input type="text" placeholder="Enter Resident ID" class="form-control" id="GenerateResidentID" name="GenerateResidentID" required>
                                        </div>                                         
                                        <div class="col-lg-4">
                                            <label class="mt-3" for="birthDate">Birth Date</label>
                                            <input type="date" placeholder="Enter Birth Date" class="form-control" id="GenerateBirthDate" name="GenerateBirthDate" required>
                                        </div>                                                          
                                        <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" placeholder="Enter Nationality" class="form-control" id="GenerateNationality" name="GenerateNationality" required>
                                        </div>                                             
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <label class="mt-3" for="birthDate">Purpose</label>
                                            <input type="text" placeholder="Enter Purpose" class="form-control" id="GeneratePurpose" name="GeneratePurpose" required> 
                                        </div>     
                                            <div class="col-lg-4">
                                            <input type="hidden" class="form-control" value="<?php echo $_SESSION["firstName"]. " " .$_SESSION["lastName"] ?>" id="GenreratedBy" name="GeneratedBy">
                                        </div>                                                                                        
                                        </div>
                                    </div> 
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto">
            <form action="COR.php" class="needs-validation" method="POST" novalidate>
                 <div class="shadow-lg p-3 mt-3 bg-body rounded">
                    <div class="container-fluid">
                        <div class="row">
                                <!-- DATA TABLE -->
                                <div class="row">
                                    <div class="col mt-3">
                                        <h3 class="title-5 m-b-18">Issuing Certificate of Residency</h3>
                                    </div>
                                </div>
                                <div id="invoice" class="p-3">
                                    <h3 class="text-decoration-underline">Resident Details</h3>
                                    <div class="row">                                       
                                        ...
                                        <div class="col-lg-4">
                                            <label class="mt-3" for="middleName">Middle Name</label>
                                            <input type="text" placeholder="Enter Middle Name" class="form-control" id="GenerateMiddleName" name="GenerateMiddleName" required>
                                        </div>                                       
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">                                          
