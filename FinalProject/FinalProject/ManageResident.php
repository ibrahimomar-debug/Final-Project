      ...
      <div class="page-container2">
                  ...
                  <div class="au-breadcrumb-content">
                    <div class="au-breadcrumb-left">
                      <ul class="list-unstyled list-inline au-breadcrumb__list">
                        ...
                        <li class="list-inline-item">Manage Resident</li>
                      </ul>
                    </div>
        ...
        <!-- END PAGE CONTAINER-->
              ...
              <div class="modal fade" id="filemodal" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header modal-header-color">
                          <h5 class="modal-title modal-title-color-text">Generate Certificate</h5>
                ...
                <input type="hidden" value="<?php echo $_SESSION["firstName"]. " " .$_SESSION["lastName"] ?>" name="GeneratedBy" class="GenerateBy">
                <input type="hidden" name="GenerateResidentID" class="GenerateResidentID">
                <input type="hidden" name="GenerateFamilyName" class="GenerateFamilyName">
                <input type="hidden" name="GenerateFirstName" class="GenerateFirstName">
                <input type="hidden" name="GenerateMiddleName" class="GenerateMiddleName">
                <input type="hidden" name="GenerateBirthDate" class="GenerateBirthDate">
                <input type="hidden" name="GenerateCivilStatus" class="GenerateCivilStatus">
                <input type="hidden" name="GenerateNationality" class="GenerateNationality">
                <input type="hidden" name="GenerateResidentStatus" class="GenerateResidentStatus">
                <input type="hidden" value="" name="GeneratePurpose" class="GeneratePurpose">

                <button type="submit" class="btn btn modal-button-color text-white mt-3 w-50">Barangay Clearance</button>
                </form>
                ...
                <button type="submit" class="btn btn modal-button-color text-white mt-3 w-50">Certificate of Residency</button>
                </form>
      ...
      <!-- End of PDF Modal -->    
                ...
                <div class="modal fade" id="deletemodal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header modal-header-color">
                            <h5 class="modal-title modal-title-color-text">Delete Resident</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                <span class="text-white" aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <input type="hidden" name="DeleteTransactionID" id="DeleteTransactionID">
                                <input type="hidden" name="DeleteResidentID" id="DeleteResidentID">
                                <input type="hidden" name="DeletePurok" id="DeletePurok">
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body modal-body-color">
            <form action="InsertResident.php" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        class="form-control"
                      >
                        <option value="None">Select Spouse's Occupation</option>
                        <option value="Private">Private</option>
                        <option value="Public">Public</option>
                        <option value="Private">Government</option>
                        <option value="Unemployed">Unemployed</option>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      >
                        ...
                        <option value="<?php echo $puroks;?>"><?php echo $puroks;?></option>
    ...
    >
      <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body modal-body-color">
            <form action="UpdateResident.php" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
              <div class="row">
                <div class="col-md-3">
...
-->        
    ...
    $('.GenerateResidentID').val(data[1]);
    $('.GenerateFamilyName').val(data[2]);
    $('.GenerateFirstName').val(data[3]);
    $('.GenerateAlias').val(data[4]);
    $('.GenerateAge').val(data[5]);
    $('.GenerateSex').val(data[6]);
    $('.GenerateCivilStatus').val(data[7]);
    $('.GenerateVoterStatus').val(data[8]);
    $('.GenerateID').val(data[9]);
    $('.GenerateMiddleName').val(data[10]);
    $('.GenerateFaceMarks').val(data[11]);
    $('.GenerateBirthDate').val(data[12]);
    $('.GenerateBirthPlace').val(data[13]);
    $('.GenerateCivilStatus').val(data[14]);
    $('.GenerateNationality').val(data[15]);
    $('.GenerateReligionBelief').val(data[16]);
    $('.GenerateOccupation').val(data[17]);
    $('.GenerateSpouseName').val(data[18]);
    $('.GenerateSpouseOccupation').val(data[19]);
    $('.GenerateCityAddress').val(data[20]);
    $('.GenerateProvincialAddress').val(data[21]);
    $('.GeneratePurok').val(data[22]);
    $('.GenerateEmailAddress').val(data[23]);
    $('.GenerateHomeNumberOne').val(data[24]);
    $('.GenerateHomeNumberTwo').val(data[25]);
    $('.GenerateMobileNumberOne').val(data[26]);
    $('.GenerateMobileNumberTwo').val(data[27]);
    $('.GenerateResidentType').val(data[28]);
    $('.GenerateResidentStatus').val(data[29]);
    $('.GenerateProcessedBy').val(data[30]);
    $('.GenerateTransactionID').val(data[31]);
    $('.GenerateDateAndTimeRegistered').val(data[32]);
    document.getElementById("GenerateImage").src="upload/"+data[33];
    ...
    $('#deleteid').val(data[9]);
    $('#DeleteTransactionID').val(data[31]);
    $('#DeleteResidentID').val(data[1]);
    $('#DeletePurok').val(data[22]);
    ...
    form.addEventListener(
      ...
      function (event) {
        if (!form.checkValidity()) {
          ...
          //document.getElementById("yearLevelText").style.display = "none";
        }
