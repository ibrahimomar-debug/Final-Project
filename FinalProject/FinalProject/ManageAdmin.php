...
<html lang="en">
    ...
    <body class="animsition">
        ...
        <!-- End of Delete Modal -->
                ...
                <!-- Start of Add Modal --> 
                <form action="InsertAdmin.php" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>              
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input minlength="6" onchange="if(this.checkValidity()) form.confirmPassword.pattern = this.value;" type="Password" id="password" name="password" placeholder="Enter Password" class="form-control" required>
                                                    </div>
                                                </div>                                                
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label  class="form-control-label">Password Confirmation</label>
                                                        <input minlength="6"  onchange="if(this.checkValidity()) form.confirmPassword.pattern = this.value;" type="Password" id="confirmPassword" name="confirm-password" placeholder="Confirm Password" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label ms-2half">Family Name</label>
                ...
                <form action="UpdateAdmin.php" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>              
                <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenteredLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                        <div class="modal-content">
                                        ...
                                        <div class="col-xl-9">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="FirstName" class="form-control-label">First Name</label>
                                                        <input type="text" placeholder="Enter First Name" id="UpdateFirstName" name="UpdateFirstName" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Family Name</label>
                                                        <input type="text" placeholder="Enter Family Name" id="UpdateLastName" name="UpdateLastName" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Middle Name</label>
                                                        <input type="text" placeholder="Enter Middle Name" id="UpdateMiddleName" name="UpdateMiddleName" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Resident ID</label>
                                                        <input type="text" placeholder="Enter Resident ID" id="UpdateResidentID" name="UpdateResidentID" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class=" form-control-label">Position</label>
                                                        <select name="UpdatePosition" id="UpdatePosition" class="form-control" required>
                                                            <option value="" disabled selected>Select Position</option>
                                                            <option value="Admin">Admin</option>
                                                            <option value="Barangay Captain">Barangay Captain</option>
                                                            <option value="Kagawad">Kagawad</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Birthday</label>
                                                        <input type="Date" placeholder="Enter Birthday" id="UpdateBirthday" name="UpdateBirthday" class="form-control" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Text" placeholder="Enter Gender" id="UpdateGender" name="UpdateGender" class="form-control" readonly>
                                                    </div>
                                                </div>                                                
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Email</label>
                                                        <input type="Email" placeholder="Enter Email" id="UpdateEmail" name="UpdateEmail" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label  class="form-control-label">Phone Number</label>
                                                        <input type="Number" placeholder="Enter Phone Number" id="UpdatePhoneNumber" name="UpdatePhoneNumber" class="form-control" required>
                                                    </div>
                                                </div>                                                
                                            </div>                                            
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nf-email" class="form-control-label">Username</label>
                                                        <input type="Text" placeholder="Enter Username" id="UpdateUsername" name="UpdateUsername" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                            ...
                            <div class="modal-footer modal-body-color">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn modal-button-color text-white" onclick="return myFunction()" id="register" name="register">Update Admin</button>
                            </div>
                        </div>
                    </div>
                </div>
