                        ...
                        <div class="login-form">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="needs-validation" method="POST" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" onchange="if(this.checkValidity()) form.confirmPassword.pattern = this.value;" class="form-control" id="password" name="password" placeholder="Enter Password" required>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput2">Confirm Password</label>
                                    <input type="password" onchange="if(this.checkValidity()) form.confirmPassword.pattern = this.value;" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="Enter Confirm Password" required>
                                    <div class="mt-2">
                                    <button class="btn modal-button-color text-white au-btn au-btn--block au-btn--green m-b-20" type="submit" onclick=" return logInfunction()" name="register" id="register">Change Password</button>
                                    </div>
                                </div>
                            </form>
