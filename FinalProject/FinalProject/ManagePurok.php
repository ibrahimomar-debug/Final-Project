...
<html lang="en">
    ...
    <body class="animsition">
        ...
        <!-- End of Delete Modal -->
                ...
                <form action="InsertPurok.php" class="needs-validation" method="POST" novalidate>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <h5 class="modal-title modal-title-color-text">ADD PUROK</h5>
                                ...
                                <label for="nf-email" class="form-control-label">Purok Name</label>
                                <input type="text" placeholder="Enter Purok Name" id="purok" name="purok" class="form-control" required>
                                </div>
                                </div>
        ...
        <!-- Start of Update Modal -->
                ...
                <form action="UpdatePurok.php" class="needs-validation" method="POST" novalidate>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <h5 class="modal-title modal-title-color-text">UPDATE PUROK</h5>
                                ...
                                <div class="form-group">
                                <label for="nf-email" class="form-control-label">Purok Name</label>
                                <input type="text" placeholder="Enter Purok Name" id="UpdatePurok" name="UpdatePurok" class="form-control" required>
        ...
        <!-- Start of View Modal -->
                ...
                <div class="modal fade" id="viewmodal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header modal-header-color">
                            <h5 class="modal-title modal-title-color-text">VIEW PUROK</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                <span class="text-white" aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="col-sm-12">
                                <div class="form-group">
                                <label for="nf-email" class="form-control-label ms-2half">Purok Name:</label>
                                ...
                                <label for="nf-email" class="form-control-label ms-2half mt-3">Population Count:</label>
