...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="AccountLogs.css" />
    ...
    <body class="animsition">
                                    ...
                                    <div class="au-breadcrumb-content">
                                        <div class="au-breadcrumb-left">
                                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                                ...
                                                <li class="list-inline-item">Account Logs</li>
                                            </ul>
                                        </div>
        ...
        <!--Beginning of First Table-->
          ...
          <h3 class="title-5 m-b-18">Account Logs</h3>
          </div>
          </div>
          ...
          <tr>
          <td class="desc"><?php echo $logs; ?></td>
