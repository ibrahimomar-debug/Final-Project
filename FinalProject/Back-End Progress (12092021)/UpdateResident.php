...
$image_err = $firstName_err = $middleName_err = $lastName_err = $residentID_err = $birthday_err = $gender_err = $position_err = $email_err = $phoneNumber_err = $username_err = $password_err = "";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //$updatedBy = trim($_POST["UpdatedBy"]);
        ...
        $sql = "UPDATE residentdata SET image = '$updateImage', familyName = '$updateFamilyName', firstName = '$updateFirstName', middleName = '$updateMiddleName', alias = '$updateAlias', faceMarks = '$updateFaceMarks', birthDate = '$updateBirthDate', birthPlace = '$updateBirthPlace', sex = '$updateSex', 
